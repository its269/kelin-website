...
export const metadata = {
    ...
    alternates: { canonical: 'https://www.kelingraphics.com/blogs-acc-reflective-tape' },
};
        ...
        "@graph": [
            {
                ...
                "description": "Learn how reflective safety tape in Black/Yellow (S501) and Red/White (S502) variants delivers high-visibility hazard marking and outdoor safety signage for industrial and commercial environments.",
                "image": "https://www.kelingraphics.com/assets/Accessories/Reflective tape.webp",
                ...
                "mainEntityOfPage": "https://www.kelingraphics.com/blogs-acc-reflective-tape"
            },
            {
                "@type": "FAQPage",
                "mainEntity": [
                    ...
                    <article className="blog-article" itemScope itemType="https://schema.org/BlogPosting">
                        ...
                        <div className="article-share-bar">
                            ...
                            <div className="share-buttons">
                                <a href={"https://www.facebook.com/sharer/sharer.php?u=https://www.kelingraphics.com/blogs-acc-reflective-tape"} target="_blank" rel="noopener noreferrer" className="share-btn share-facebook" aria-label="Share on Facebook"><svg viewBox="0 0 24 24" fill="currentColor"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" /></svg>Facebook</a>
                            </div>
                        </div>
