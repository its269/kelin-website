...
export default function FuleiBU1425FAFlatbedLaminator() {
    ...
    const handleSubmitInquiry = async (e) => {
        ...
        formData.append('Page Source', 'Fulei BU-1425FA Flatbed Laminator');
        formData.append('_replyto', formData.get('email') || '');
        formData.append('_subject', 'Inquiry: Fulei BU-1425FA Flatbed Laminator');
                ...
                <div className="fulei-1425fa-modal-overlay" onClick={closeInquiryModal}>
                    <div className="fulei-1425fa-inquiry-modal" onClick={(e) => e.stopPropagation()}>
                        ...
                        <form onSubmit={handleSubmitInquiry} className="fulei-1425fa-inquiry-form">
                            {submitSuccess === true && (
                                <div className="fulei-1425fa-form-success">Thank you for your inquiry! We will contact you soon.</div>
                            )}
                            {submitSuccess === false && (
                                <div className="fulei-1425fa-form-error">Sorry, there was an error submitting your inquiry. Please try again.</div>
                            )}
                            ...
                            <div className="fulei-1425fa-form-actions">
                                <button type="submit" className="fulei-1425fa-btn-primary" disabled={submitting}>
                                    {submitting ? 'Sending...' : 'Send Inquiry'}
                                </button>
                                <button type="button" onClick={closeInquiryModal} className="fulei-1425fa-btn-secondary" disabled={submitting}>Cancel</button>
                            </div>
                        </form>
                    </div>
                </div>
