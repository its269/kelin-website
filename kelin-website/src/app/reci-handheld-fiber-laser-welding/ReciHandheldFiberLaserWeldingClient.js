...
export default function ReciHandheldFiberLaserWelding() {
    ...
    async function handleSubmitInquiry(e) {
        ...
        data.append('Page Source', 'RECI Handheld Fiber Laser Welding');
        data.append('_replyto', data.get('email') || '');
        data.append('_subject', 'Inquiry: RECI Handheld Fiber Laser Welding');
                    ...
                    <div className="reci-welding-inquiry-modal" onClick={(e) => e.stopPropagation()}>
                        ...
                        <form onSubmit={handleSubmitInquiry} className="reci-welding-inquiry-form">
                            ...
                            <div className="reci-welding-form-row">
                                ...
                                <div className="reci-welding-form-group">
                                    ...
                                    <div className="reci-welding-phone-input">
                                        <select className="reci-welding-country-select" name="countryCode" defaultValue="+63" required>
                            ...
                            <div className="reci-welding-form-actions">
                                <button type="submit" className="reci-welding-btn-primary" disabled={submitting}>
                                    {submitting ? "Sending..." : "Send Inquiry"}
                                </button>
                                <button type="button" onClick={closeInquiryModal} className="reci-welding-btn-secondary" disabled={submitting}>Cancel</button>
                            </div>
                        </form>
                    </div>
                </div>
