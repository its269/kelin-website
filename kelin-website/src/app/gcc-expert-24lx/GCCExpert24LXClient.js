...
export default function GCCExpert24LX() {
    ...
    const handleSubmitInquiry = async (e) => {
        ...
        const data = {
            ...
            _subject: `Inquiry: GCC Expert 24 LX`,
            'Page Source': 'GCC Expert 24 LX',
                        ...
                        >
                            <div className="gcc-expert-24lx-applications-image-grid">
                                {loopedApplicationItems.map((item, index) => (
                                    <div key={`${item.label}-${index}`} className="gcc-expert-24lx-application-image-item">
                    ...
                    <div className="gcc-expert-24lx-inquiry-modal" onClick={(e) => e.stopPropagation()}>
                        ...
                        <form onSubmit={handleSubmitInquiry} className="gcc-expert-24lx-inquiry-form">
                            ...
                            <div className="gcc-expert-24lx-form-row">
                                ...
                                <div className="gcc-expert-24lx-form-group">
                                    ...
                                    <div className="gcc-expert-24lx-phone-input">
                                        <select name="countryCode" className="gcc-expert-24lx-country-select" defaultValue="+63" required>
                            ...
                            <div className="gcc-expert-24lx-form-actions">
                                <button type="submit" className="gcc-expert-24lx-btn-primary" disabled={inquirySubmitting}>
