...
export default function XlineEcoSolventPage() {
    ...
    const handleSubmitInquiry = async (e) => {
        ...
        const data = {
            ...
            _subject: `Inquiry: XLINE Eco-Solvent`,
            'Page Source': 'XLINE Eco-Solvent',
        ...
        <div>
            ...
            <main className="xline-main">
                ...
                <section className="videoPlayer-section">
                    <VideoPlayer src="/xline-eco-solvent.mp4" poster="" className="" />
                </section>

                {/* Key Features */}
                <section className="xline-features-section" style={{ marginTop: '100px' }}>
                    ...
                    <div className="xline-inquiry-modal" onClick={(e) => e.stopPropagation()}>
                        ...
                        <form onSubmit={handleSubmitInquiry} className="xline-inquiry-form">
                            ...
                            <div className="xline-form-actions">
                                <button type="submit" className="xline-btn-primary" disabled={inquirySubmitting}>
