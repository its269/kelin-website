...
export default function R2000Roller() {
    ...
    async function handleSubmitInquiry(e) {
        ...
        data.append('Page Source', 'R2000 Roller Sublimation Machine');
        data.append('_replyto', data.get('email') || '');
        data.append('_subject', 'Inquiry: R2000 Roller Sublimation Machine');
                    ...
                    <div className="r2000-roller-inquiry-modal" onClick={(e) => e.stopPropagation()}>
                        ...
                        <form onSubmit={handleSubmitInquiry} className="r2000-roller-inquiry-form">
                            ...
                            <div className="r2000-roller-form-actions">
                                <button type="submit" className="r2000-roller-btn-primary" disabled={submitting}>
                                    {submitting ? "Sending..." : "Send Inquiry"}
                                </button>
                                <button type="button" onClick={closeInquiryModal} className="r2000-roller-btn-secondary" disabled={submitting}>
                                    Cancel
                                </button>
                            </div>
                        </form>
