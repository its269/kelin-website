...
export const metadata = {
    ...
    alternates: { canonical: 'https://www.kelingraphics.com/blogs-ink-dtf-cleaning' },
};
        ...
        "@graph": [
            {
                ...
                "description": "Guide to DTF printer cleaning solutions — printhead flushing, ink channel maintenance, and storage preparation for DTF direct-to-film printing systems.",
                "image": "https://www.kelingraphics.com/inks/DTF CLEANING SOLUTIONS/DTF Cleaning Solution 500ml.webp",
                ...
                "mainEntityOfPage": "https://www.kelingraphics.com/blogs-ink-dtf-cleaning"
            },
            {
                "@type": "FAQPage",
                "mainEntity": [
                ...
                <main className="blog-main">
                    <article className="blog-article" itemScope itemType="https://schema.org/BlogPosting">
                        ...
                        <div className="article-share-bar"><span className="share-label">Share this article</span><div className="share-buttons">
                            <a href="https://www.facebook.com/sharer/sharer.php?u=https://www.kelingraphics.com/blogs-ink-dtf-cleaning" target="_blank" rel="noopener noreferrer" className="share-btn share-facebook" aria-label="Share on Facebook"><svg viewBox="0 0 24 24" fill="currentColor"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" /></svg>Facebook</a>
                            <a href="https://twitter.com/intent/tweet?url=https://www.kelingraphics.com/blogs-ink-dtf-cleaning" target="_blank" rel="noopener noreferrer" className="share-btn share-twitter" aria-label="Share on Twitter/X"><svg viewBox="0 0 24 24" fill="currentColor"><path d="M4 4l16 16M4 20L20 4" stroke="currentColor" strokeWidth="2" /></svg>Twitter / X</a>
                            <a href="https://www.linkedin.com/shareArticle?mini=true&url=https://www.kelingraphics.com/blogs-ink-dtf-cleaning" target="_blank" rel="noopener noreferrer" className="share-btn share-linkedin" aria-label="Share on LinkedIn"><svg viewBox="0 0 24 24" fill="currentColor"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z" /><rect x="2" y="9" width="4" height="12" /><circle cx="4" cy="4" r="2" /></svg>LinkedIn</a>
                        </div></div>
