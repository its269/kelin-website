...
export default function KSignLetterShell3DPrinter() {
    ...
    const applicationItems = [
        { image: '/application/3d-printer/1.png', label: 'Letter Shell Production' },
        { image: '/application/3d-printer/2.png', label: '3D Signage' },
        { image: '/application/3d-printer/3.png', label: 'Channel Letters' },
        { image: '/application/3d-printer/4.png', label: 'Dimensional Lettering' },
        { image: '/application/3d-printer/5.png', label: 'Custom Sign Components' },
        { image: '/application/3d-printer/6.png', label: 'Architectural Signage' },
    ];
                        ...
                        >
                            <div className="k-sign-3d-printer-applications-image-grid">
                                {loopedApplicationItems.map((item, index) => (
                                    <div key={`${item.label}-${index}`} className="k-sign-3d-printer-application-image-item">
                            ...
                            <div className="k-sign-3d-printer-form-row">
                                ...
                                <div className="k-sign-3d-printer-form-group">
                                    ...
                                    <div className="k-sign-3d-printer-phone-input">
                                        <select className="k-sign-3d-printer-country-select" name="countryCode" defaultValue="+63" required>
