...
export default function UVPrinters() {
    ...
    const uvMachines = [
        ...
        },
        {
            ...
            badge: 'Large Format',
            price: 'Contact us for more details',
            link: '/automatic-uv-crystal-flat-pasting'
        },
        {
            ...
            badge: 'Hybrid',
            price: 'Contact us for more details',
            link: '/liyu-x-line-dqs-uv-hybrid-printer'
        },
        {
            id: 'smart-uv-printer',
                    ...
                    <div className="uv-printers-inquiry-modal" onClick={(e) => e.stopPropagation()}>
                        ...
                        <form onSubmit={handleInquirySubmit} className="uv-printers-inquiry-form">
                            ...
                            <div className="uv-printers-form-actions">
                                <button type="submit" className="uv-printers-btn-primary" disabled={inquirySubmitting}>
