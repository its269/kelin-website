...
export const metadata = {
    ...
    alternates: { canonical: 'https://www.kelingraphics.com/blogs-pd-portable-backdrop' },
};
        ...
        "@graph": [
            {
                ...
                "description": "Complete guide to portable backdrop systems — telescoping stand design, banner sizing, photography and event branding use cases, and how portable backdrops compare to pop-up display structures.",
                "image": "https://www.kelingraphics.com/promotional-display/portable-backdrop.webp",
                ...
                "mainEntityOfPage": "https://www.kelingraphics.com/blogs-pd-portable-backdrop"
            },
            {
                "@type": "FAQPage",
                "mainEntity": [
                    ...
                    <article className="blog-article" itemScope itemType="https://schema.org/BlogPosting">
                        ...
                        <div className="article-share-bar">
                            ...
                            <div className="share-buttons">
                                <a href="https://www.facebook.com/sharer/sharer.php?u=https://www.kelingraphics.com/blogs-pd-portable-backdrop" target="_blank" rel="noopener noreferrer" className="share-btn share-facebook" aria-label="Share on Facebook"><svg viewBox="0 0 24 24" fill="currentColor"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" /></svg>Facebook</a>
                                <a href="https://twitter.com/intent/tweet?url=https://www.kelingraphics.com/blogs-pd-portable-backdrop" target="_blank" rel="noopener noreferrer" className="share-btn share-twitter" aria-label="Share on Twitter"><svg viewBox="0 0 24 24" fill="currentColor"><path d="M4 4l16 16M4 20L20 4" stroke="currentColor" strokeWidth="2" /></svg>Twitter / X</a>
                            </div>
                        </div>
