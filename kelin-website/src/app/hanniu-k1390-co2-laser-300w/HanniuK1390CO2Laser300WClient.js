...
export default function HanniuK1390CO2Laser300W() {
    ...
    const handleSubmitInquiry = async (e) => {
        ...
        formData.append('Page Source', 'Hanniu K1390 CO2 Laser 300W');
        formData.append('_replyto', formData.get('email') || '');
        formData.append('_subject', 'Inquiry: Hanniu K1390 CO2 Laser 300W');
                ...
                <div className="hanniu-300w-modal-overlay" onClick={closeInquiryModal}>
                    <div className="hanniu-300w-inquiry-modal" onClick={(e) => e.stopPropagation()}>
                        ...
                        <form onSubmit={handleSubmitInquiry} className="hanniu-300w-inquiry-form">
                            {submitSuccess === true && (
                                <div className="hanniu-300w-form-success">Thank you for your inquiry! We will contact you soon.</div>
                            )}
                            {submitSuccess === false && (
                                <div className="hanniu-300w-form-error">Sorry, there was an error submitting your inquiry. Please try again.</div>
                            )}
                            ...
                            <div className="hanniu-k1390-300w-form-row">
                                <div className="hanniu-300w-form-group">
                            ...
                            <div className="hanniu-k1390-300w-form-row">
                                ...
                                <div className="hanniu-300w-form-group">
                                    ...
                                    <div className="hanniu-300w-phone-input">
                                        <select className="hanniu-300w-country-select" name="countryCode" defaultValue="+63" required>
                            ...
                            <div className="hanniu-300w-form-actions">
                                <button type="submit" className="hanniu-300w-btn-primary" disabled={submitting}>
                                    {submitting ? 'Sending...' : 'Send Inquiry'}
                                </button>
                                <button type="button" onClick={closeInquiryModal} className="hanniu-300w-btn-secondary" disabled={submitting}>Cancel</button>
                            </div>
                        </form>
                    </div>
                </div>
