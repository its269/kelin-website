...
export const metadata = {
    ...
    keywords: [
        ...
        "sublimation heat press Philippines",
        "DTF heat press",
                            ...
                            <section className="article-section" id="features">
                                ...
                                <div className="feature-cards-grid">
                                    <div className="feature-card">
                                        ...
                                        <p>
                                            This manual heat press boasts a unique drawer-like mechanism. The innovative design allows users to easily slide out the lower platen, providing ample space and clear access for precisely positioning materials such as T-shirts or fabric banners.
                                        </p>
                                    </div>
                                    <div className="feature-card">
                                        <div className="feature-card-icon">
                                        ...
                                        <p>
                                            The Subli-Mate incorporates a roller as a core component of its design. This integrated roller plays a crucial role in the machine's functionality and ease of use, enabling smooth movement and precise material positioning.
                                        </p>
                                    </div>
                                    <div className="feature-card">
                                        <div className="feature-card-icon">
