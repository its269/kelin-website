...
export default function GCCExpert52LX() {
    ...
    const applicationItems = [
        { image: '/application/Expert LX/car decals.webp', label: 'Car Decals' },
        { image: '/application/Expert LX/car decals(2).webp', label: 'Vinyl Cutting' },
        { image: '/application/Expert LX/car decals(3).webp', label: 'Custom Decals' },
        { image: '/application/Expert LX/car decals(4).webp', label: 'Sign Making' },
    ];
    ...
    const handleSubmitInquiry = async (e) => {
        ...
        const data = {
            ...
            _subject: `Inquiry: GCC Expert 52 LX`,
            'Page Source': 'GCC Expert 52 LX',
                                    ...
                                    <div className="gcc-expert-52lx-feature-icon">
                                        {index === 0 && (
                                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                                {/* Robust cutting force: bold downward press */}
                                        ...
                                        {index === 3 && (
                                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                                {/* Auto contour cutting: path with scissors */}
                        ...
                        >
                            <div className="gcc-expert-52lx-applications-image-grid">
                                {loopedApplicationItems.map((item, index) => (
                                    <div key={`${item.label}-${index}`} className="gcc-expert-52lx-application-image-item">
                ...
                <div className="gcc-expert-52lx-modal-overlay" onClick={closeInquiryModal}>
                    <div className="gcc-expert-52lx-inquiry-modal" onClick={(e) => e.stopPropagation()}>
                        ...
                        <form onSubmit={handleSubmitInquiry} className="gcc-expert-52lx-inquiry-form">
                            ...
                            <div className="gcc-expert-52lx-form-row">
                                ...
                                <div className="gcc-expert-52lx-form-group">
                                    ...
                                    <div className="gcc-expert-52lx-phone-input">
                                        <select name="countryCode" className="gcc-expert-52lx-country-select" defaultValue="+63" required>
                            ...
                            <div className="gcc-expert52lx-form-row">
                                <div className="gcc-expert-52lx-form-group">
                            ...
                            <div className="gcc-expert-52lx-form-actions">
                                <button type="submit" className="gcc-expert-52lx-btn-primary" disabled={inquirySubmitting}>
