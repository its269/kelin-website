...
export default function HanniuK1390CO2Laser150WCCD() {
    ...
    const applicationItems = [
        { image: '/application/hanniu-k1390/1.png', label: 'Fabric Cutting' },
        { image: '/application/hanniu-k1390/2.png', label: 'Leather Processing' },
        { image: '/application/hanniu-k1390/3.png', label: 'Acrylic Engraving' },
        { image: '/application/hanniu-k1390/4.png', label: 'Wood Products' },
    ];
                                    ...
                                    <div className="hanniu-k1390-feature-icon">
                                        {index === 0 && (
                                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                                {/* All-in-one standalone: box with all features */}
                                        ...
                                        {index === 2 && (
                                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                                {/* Enhanced large-view camera: wide angle */}
                                                <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z" />
                                                <circle cx="12" cy="12" r="3" />
                                                <line x1="1" y1="6" x2="5" y2="10" />
                                                <line x1="23" y1="6" x2="19" y2="10" />
                                            </svg>
                                        )}
                                        {index === 3 && (
                                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                                {/* Suitable material: check/layers */}
                        ...
                        >
                            <div className="hanniu-k1390-applications-image-grid">
                                {loopedApplicationItems.map((item, index) => (
                                    <div key={`${item.label}-${index}`} className="hanniu-k1390-application-image-item">
                ...
                <div className="hanniu-k1390-modal-overlay" onClick={closeInquiryModal}>
                    <div className="hanniu-k1390-inquiry-modal" onClick={(e) => e.stopPropagation()}>
                        ...
                        <form onSubmit={handleSubmitInquiry} className="hanniu-k1390-inquiry-form">
                            ...
                            <div className="hanniu-k1390-150w-form-row">
                                <div className="hanniu-k1390-form-group">
                                ...
                                <div className="hanniu-k1390-form-group">
                                    ...
                                    <div className="hanniu-k1390-phone-input">
                                        <select className="hanniu-k1390-country-select" name="countryCode" defaultValue="+63" required>
