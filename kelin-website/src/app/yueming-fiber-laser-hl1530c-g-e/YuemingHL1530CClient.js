...
export default function YuemingHL1530C() {
    ...
    const applicationItems = [
        { image: '/application/yueming-fiber-laser-hl1530c-g-e/1.png', label: 'Metal Sheet Cutting' },
        { image: '/application/yueming-fiber-laser-hl1530c-g-e/2.png', label: 'Stainless Steel' },
        { image: '/application/yueming-fiber-laser-hl1530c-g-e/3.png', label: 'Carbon Steel' },
        { image: '/application/yueming-fiber-laser-hl1530c-g-e/4.png', label: 'Precision Fabrication' },
    ];
    ...
    async function handleSubmitInquiry(e) {
        ...
        data.append('Page Source', 'Yueming Fiber Laser HL1530C-G-E');
        data.append('_replyto', data.get('email') || '');
        data.append('_subject', 'Inquiry: Yueming Fiber Laser HL1530C-G-E');
                            ...
                            {machineDetails.features.map((feature, index) => (
                                <div key={index} className="yueming-hl1530c-feature-card">
                                    <div className="yueming-hl1530c-feature-icon">
                                        ...
                                        {index === 1 && (
                                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                                {/* Intelligent analysis: brain/CPU chip */}
                                        ...
                                        {index === 2 && (
                                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                                {/* Sensor dashboard: gauge/meter */}
                                                <path d="M3 12 a9 9 0 1 1 18 0" />
                                        ...
                                        {index === 3 && (
                                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                                {/* Leapfrog motion: arching jump path */}
                                                <path d="M2 18 Q7 4 12 18 Q17 4 22 18" />
                        ...
                        >
                            <div className="yueming-hl1530c-applications-image-grid">
                                {loopedApplicationItems.map((item, index) => (
                                    <div key={`${item.label}-${index}`} className="yueming-hl1530c-application-image-item">
                    ...
                    <div className="yueming-hl1530c-inquiry-modal" onClick={(e) => e.stopPropagation()}>
                        ...
                        <form onSubmit={handleSubmitInquiry} className="yueming-hl1530c-inquiry-form">
                            ...
                            <div className="yueming-hl1530c-form-row">
                                ...
                                <div className="yueming-hl1530c-form-group">
                                    ...
                                    <div className="yueming-hl1530c-phone-input">
                                        <select className="yueming-hl1530c-country-select" name="countryCode" defaultValue="+63" required>
                            ...
                            <div className="yueming-hl1530c-form-actions">
                                <button type="submit" className="yueming-hl1530c-btn-primary" disabled={submitting}>
                                    {submitting ? "Sending..." : "Send Inquiry"}
                                </button>
                                <button type="button" onClick={closeInquiryModal} className="yueming-hl1530c-btn-secondary" disabled={submitting}>Cancel</button>
                            </div>
                        </form>
                    </div>
                </div>
