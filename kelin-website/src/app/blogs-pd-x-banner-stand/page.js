...
export const metadata = {
    ...
    alternates: { canonical: 'https://www.kelingraphics.com/blogs-pd-x-banner-stand' },
};
        ...
        "@graph": [
            {
                ...
                "description": "A complete guide to X Banner Stands — how they work, best sizes, setup tips, and ideal use cases for indoor promotions, storefronts, and events in the Philippines.",
                "image": "https://www.kelingraphics.com/promotional-display/x-banner-stand.webp",
                ...
                "mainEntityOfPage": "https://www.kelingraphics.com/blogs-pd-x-banner-stand"
            },
            {
                "@type": "FAQPage",
                "mainEntity": [
                    ...
                    <article className="blog-article" itemScope itemType="https://schema.org/BlogPosting">
                        ...
                        <div className="article-share-bar">
                            ...
                            <div className="share-buttons">
                                <a href="https://www.facebook.com/sharer/sharer.php?u=https://www.kelingraphics.com/blogs-pd-x-banner-stand" target="_blank" rel="noopener noreferrer" className="share-btn share-facebook" aria-label="Share on Facebook">
                                ...
                                <a href="https://twitter.com/intent/tweet?url=https://www.kelingraphics.com/blogs-pd-x-banner-stand" target="_blank" rel="noopener noreferrer" className="share-btn share-twitter" aria-label="Share on Twitter">
