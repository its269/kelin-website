...
export default function DTFUVPrinterSF604I3200() {
    ...
    const applicationItems = [
        { image: '/application/SF604/1.png', label: 'Custom Stickers' },
        { image: '/application/SF604/2.png', label: 'Phone Cases' },
        { image: '/application/SF604/3.png', label: 'Decorative Items' },
        { image: '/application/SF604/4.png', label: 'Promotional Products' },
        { image: '/application/SF604/5.png', label: 'Personalized Gifts' },
        { image: '/application/SF604/6.png', label: 'Awards & Trophies' },
    ];
            ...
            <main className="dtf-uv-sf604-main">
                ...
                <section className="dtf-uv-sf604-applications-section">
                    <div className="dtf-uv-sf604-applications-container">
                        ...
                        <div
                            ref={scrollRef}
                            className="dtf-uv-sf604-applications-scroll"
                        ...
                        >
                            <div className="dtf-uv-sf604-applications-image-grid">
                                {loopedApplicationItems.map((item, index) => (
                                    <div key={`${item.label}-${index}`} className="dtf-uv-sf604-application-image-item">
                        ...
                        <div className="dtf-uv-sf604-advantages-grid">
                            {machineDetails.advantages.map((advantage, index) => (
                                <div key={index} className="dtf-uv-sf604-advantage-item">
                                    <svg className="dtf-uv-sf604-advantage-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
