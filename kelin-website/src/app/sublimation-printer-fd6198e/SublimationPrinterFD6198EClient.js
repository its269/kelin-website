...
export default function SublimationPrinterFD6198E() {
    ...
    const applicationItems = [
        { image: '/application/eight-head-sublimation-printer/1.webp' },
        { image: '/application/eight-head-sublimation-printer/2.webp' },
        { image: '/application/eight-head-sublimation-printer/3.webp' },
        { image: '/application/eight-head-sublimation-printer/4.webp' },
        { image: '/application/eight-head-sublimation-printer/5.webp' },
        { image: '/application/eight-head-sublimation-printer/6.webp' }
    ];
    ...
    const handleSubmitInquiry = async (e) => {
        ...
        const data = {
            ...
            _subject: `Inquiry: Sublimation Printer FD6198E`,
            'Page Source': 'Sublimation Printer FD6198E',
                ...
                <section className="fd6198e-printer-applications-section">
                    <div className="fd6198e-printer-applications-container">
                        ...
                        <p className="fd6198e-printer-applications-subtitle">
                            Versatile sublimation solutions for professional applications
                        </p>
                        <div
                            ref={scrollRef}
                        ...
                        >
                            <div className="fd6198e-printer-applications-image-grid">
                                {loopedApplicationItems.map((item, index) => (
                                    <div key={`${item.label}-${index}`} className="fd6198e-printer-application-image-item">
                    ...
                    <div className="fd6198e-printer-inquiry-modal" onClick={(e) => e.stopPropagation()}>
                        ...
                        <form onSubmit={handleSubmitInquiry} className="fd6198e-printer-inquiry-form">
                            ...
                            <div className="fd6198e-printer-form-row">
                                ...
                                <div className="fd6198e-printer-form-group">
                                    ...
                                    <div className="fd6198e-printer-phone-input">
                                        <select name="countryCode" className="fd6198e-printer-country-select" defaultValue="+63" required>
                            ...
                            <div className="fd6198e-printer-form-actions">
                                <button type="submit" className="fd6198e-printer-btn-primary" disabled={inquirySubmitting}>
