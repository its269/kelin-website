...
export default function HandheldFiberLaser() {
    ...
    const applicationItems = [
        { image: '/application/handheld-fiber-laser/1.png', label: 'Elevator Manufacturing' },
        { image: '/application/handheld-fiber-laser/2.png', label: 'Metal Processing' },
        { image: '/application/handheld-fiber-laser/3.png', label: 'Machinery Manufacturing' },
        { image: '/application/handheld-fiber-laser/4.png', label: 'Automotive Manufacturing' },
        { image: '/application/handheld-fiber-laser/5.png', label: 'Steel Structures' },
    ];
    ...
    const handleSubmitInquiry = async (e) => {
        ...
        formData.append('Page Source', 'Handheld Fiber Laser');
        formData.append('_replyto', formData.get('email') || '');
        formData.append('_subject', 'Inquiry: Handheld Fiber Laser');
                                    ...
                                    <div className="handheld-laser-feature-icon">
                                        {index === 0 && (
                                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                                {/* Fast welding speed: lightning bolt */}
                                                <path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z" />
                                            </svg>
                                        )}
                                        {index === 1 && (
                                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                                {/* Beginner-friendly: hand/thumb up */}
                                        ...
                                        {index === 2 && (
                                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                                {/* High quality weld finish: sparkle/star */}
                                                <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" />
                                            </svg>
                                        )}
                                        {index === 3 && (
                                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                                {/* Support various welding: layers/versatile */}
                        ...
                        >
                            <div className="handheld-laser-applications-image-grid">
                                {loopedApplicationItems.map((item, index) => (
                                    <div key={`${item.label}-${index}`} className="handheld-laser-application-image-item">
                ...
                <div className="handheld-laser-modal-overlay" onClick={closeInquiryModal}>
                    <div className="handheld-laser-inquiry-modal" onClick={(e) => e.stopPropagation()}>
                        ...
                        <form onSubmit={handleSubmitInquiry} className="handheld-laser-inquiry-form">
                            {submitSuccess === true && (
                                <div className="handheld-laser-form-success">Thank you for your inquiry! We will contact you soon.</div>
                            )}
                            {submitSuccess === false && (
                                <div className="handheld-laser-form-error">Sorry, there was an error submitting your inquiry. Please try again.</div>
                            )}
                            ...
                            <div className="handheld-fiber-form-row">
                                <div className="handheld-laser-form-group">
                            ...
                            <div className="handheld-laser-form-row">
                                ...
                                <div className="handheld-laser-form-group">
                                    ...
                                    <div className="handheld-laser-phone-input">
                                        <select className="handheld-laser-country-select" name="countryCode" defaultValue="+63" required>
                            ...
                            <div className="handheld-laser-form-actions">
                                <button type="submit" className="handheld-laser-btn-primary" disabled={submitting}>
                                    {submitting ? 'Sending...' : 'Send Inquiry'}
                                </button>
                                <button type="button" onClick={closeInquiryModal} className="handheld-laser-btn-secondary" disabled={submitting}>Cancel</button>
                            </div>
                        </form>
                    </div>
                </div>
