...
export default function GCCPumaIV() {
    ...
    const applicationItems = [
        { image: '/application/Puma/Box Packaging.webp', label: 'Box Packaging' },
        { image: '/application/Puma/Car Decals.webp', label: 'Car Decals' },
        { image: '/application/Puma/Colored Sticker.webp', label: 'Colored Sticker' },
        { image: '/application/Puma/Food Label.webp', label: 'Food Label' },
        { image: '/application/Puma/Vinyl Sign.webp', label: 'Vinyl Sign' },
    ];
    ...
    const handleSubmitInquiry = async (e) => {
        ...
        const data = {
            ...
            _subject: `Inquiry: GCC Puma IV`,
            'Page Source': 'GCC Puma IV',
                        ...
                        >
                            <div className="gcc-puma-applications-image-grid">
                                {loopedApplicationItems.map((item, index) => (
                                    <div key={`${item.label}-${index}`} className="gcc-puma-application-image-item">
                    ...
                    <div className="gcc-puma-inquiry-modal" onClick={(e) => e.stopPropagation()}>
                        ...
                        <form onSubmit={handleSubmitInquiry} className="gcc-puma-inquiry-form">
                            ...
                            <div className="gcc-puma-form-row">
                                ...
                                <div className="gcc-puma-form-group">
                                    ...
                                    <div className="gcc-puma-phone-input">
                                        <select name="countryCode" className="gcc-puma-country-select" defaultValue="+63" required>
                            ...
                            <div className="gcc-puma-form-actions">
                                <button type="submit" className="gcc-puma-btn-primary" disabled={inquirySubmitting}>
