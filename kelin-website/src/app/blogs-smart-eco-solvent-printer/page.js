...
export const metadata = {
    ...
    alternates: {
        canonical: 'https://www.kelingraphics.com/blogs-smart-eco-solvent-printer',
    },
};
        ...
        "@graph": [
            {
                ...
                "image": "https://www.kelingraphics.com/eco-solvent-machines/SMART.webp",
                ...
                "mainEntityOfPage": "https://www.kelingraphics.com/blogs-smart-eco-solvent-printer"
            },
            {
                "@type": "FAQPage",
                "mainEntity": [
                    ...
                    <article className="blog-article" itemScope itemType="https://schema.org/Article">
                        ...
                        <div className="article-share-bar">
                            ...
                            <div className="share-buttons">
                                <a href="https://www.facebook.com/sharer/sharer.php?u=https://www.kelingraphics.com/blogs-smart-eco-solvent-printer" target="_blank" rel="noopener noreferrer" className="share-btn share-facebook" aria-label="Share on Facebook">
                                    <svg viewBox="0 0 24 24" fill="currentColor"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" /></svg>
                                    Facebook
                                </a>
                                <a href="https://twitter.com/intent/tweet?url=https://www.kelingraphics.com/blogs-smart-eco-solvent-printer&text=What+Is+an+Eco-Solvent+Printer%3F+Complete+Guide+2026" target="_blank" rel="noopener noreferrer" className="share-btn share-twitter" aria-label="Share on Twitter/X">
                                    <svg viewBox="0 0 24 24" fill="currentColor"><path d="M4 4l16 16M4 20L20 4" stroke="currentColor" strokeWidth="2" /></svg>
                                    Twitter / X
                                </a>
                                <a href="https://www.linkedin.com/shareArticle?mini=true&url=https://www.kelingraphics.com/blogs-smart-eco-solvent-printer" target="_blank" rel="noopener noreferrer" className="share-btn share-linkedin" aria-label="Share on LinkedIn">
