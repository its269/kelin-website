...
export default function KSignDesktopLaserMarking() {
    ...
    const applicationItems = [
        { image: '/application/k-sign-desktop-laser-marking/branding.png', label: 'Branding & Logos' },
        { image: '/application/k-sign-desktop-laser-marking/cards.webp', label: 'Business Cards' },
        { image: '/application/k-sign-desktop-laser-marking/Personalized.webp', label: 'Personalized Items' },
        { image: '/application/k-sign-desktop-laser-marking/keychain.jpg', label: 'Keychains' },
        { image: '/application/k-sign-desktop-laser-marking/Customized Designed.webp', label: 'Customized Designs' },
    ];
    ...
    const handleSubmitInquiry = async (e) => {
        ...
        formData.append('Page Source', 'K-Sign Desktop Laser Marking');
        formData.append('_replyto', formData.get('email') || '');
        formData.append('_subject', 'Inquiry: K-Sign Desktop Laser Marking');
                                    ...
                                    <div className="ksign-marking-feature-icon">
                                        {index === 0 && (
                                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                                {/* Field mirror: lens/hexagon optic */}
                                        ...
                                        {index === 1 && (
                                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                                {/* High-speed galvanometer: rotating arrow */}
                                        ...
                                        {index === 2 && (
                                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                                {/* Extended optical path: long beam */}
                                        ...
                                        {index === 3 && (
                                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                                {/* Beam height adjuster: vertical slider */}
                        ...
                        >
                            <div className="ksign-marking-applications-image-grid">
                                {loopedApplicationItems.map((item, index) => (
                                    <div key={`${item.label}-${index}`} className="ksign-marking-application-image-item">
                ...
                <div className="ksign-marking-modal-overlay" onClick={closeInquiryModal}>
                    <div className="ksign-marking-inquiry-modal" onClick={(e) => e.stopPropagation()}>
                        ...
                        <form onSubmit={handleSubmitInquiry} className="ksign-marking-inquiry-form">
                            ...
                            <div className="k-sign-marking-form-row">
                                <div className="ksign-marking-form-group">
                            ...
                            <div className="k-sign-marking-form-row">
                                ...
                                <div className="ksign-marking-form-group">
                                    ...
                                    <div className="ksign-marking-phone-input">
                                        <select className="ksign-marking-country-select" name="countryCode" defaultValue="+63" required>
                            ...
                            <div className="ksign-marking-form-actions">
                                <button type="submit" className="ksign-marking-btn-primary" disabled={inquiryStatus === 'loading'}>
                                    {inquiryStatus === 'loading' ? 'Sending...' : 'Send Inquiry'}
                                </button>
                                <button type="button" onClick={closeInquiryModal} className="ksign-marking-btn-secondary" disabled={inquiryStatus === 'loading'}>Cancel</button>
                            </div>
