...
export default function KirinDA182TPlus() {
    ...
    const applicationItems = [
        { image: '/application/kirin-application/_0000_7.webp', label: 'High-Volume Textile Printing' },
        { image: '/application/kirin-application/_0001_6.webp', label: 'Fashion & Apparel Production' },
        { image: '/application/kirin-application/_0002_5.webp', label: 'Home Textiles & Furnishing' },
        { image: '/application/kirin-application/_0003_4.webp', label: 'Pillow Covers' },
        { image: '/application/kirin-application/_0004_3.webp', label: 'Large-Scale Soft Signage' },
        { image: '/application/kirin-application/_0005_2.webp', label: 'Custom Fabric Printing' },
        { image: '/application/kirin-application/_0006_1.webp', label: 'Furniture' },
    ];
    ...
    const handleSubmitInquiry = async (e) => {
        ...
        const data = {
            ...
            _subject: `Inquiry: ${machineDetails.name}`,
            'Page Source': machineDetails.name,
                        ...
                        >
                            <div className="kirin-da182t-applications-image-grid">
                                {loopedApplicationItems.map((item, index) => (
                                    <div key={`${item.label}-${index}`} className="kirin-da182t-application-image-item">
                    ...
                    <div className="kirin-da182t-inquiry-modal" onClick={(e) => e.stopPropagation()}>
                        ...
                        <form onSubmit={handleSubmitInquiry} className="kirin-da182t-inquiry-form">
                            ...
                            <div className="kirin-da182t-form-row">
                                ...
                                <div className="kirin-da182t-form-group">
                                    ...
                                    <div className="kirin-da182t-phone-input">
                                        <select name="countryCode" className="kirin-da182t-country-select" defaultValue="+63" required>
                            ...
                            <div className="kirin-da182t-form-actions">
                                <button type="submit" className="kirin-da182t-btn-primary" disabled={inquirySubmitting}>
