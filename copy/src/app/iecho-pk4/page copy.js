...
export default function IEchoPK4() {
    ...
    const applicationImageItems = [
        { image: '/application/_0000_6.jpg', title: 'KT Board Processing' },
        { image: '/application/_0001_5.jpg', title: 'PP Paper Cutting' },
        { image: '/application/_0002_4.jpg', title: 'Sticker & Vinyl Applications' },
        { image: '/application/_0003_3.jpg', title: 'Foam Board Manufacturing' },
        { image: '/application/_0004_2.jpg', title: 'Plastic Sheet Processing' },
        { image: '/application/_0005_1.jpg', title: 'Magnetic Sticker Production' },
        { image: '/application/_0000_6.jpg', title: 'Corrugated Board Cutting' },
        { image: '/application/_0001_5.jpg', title: 'Card Board Processing' },
        { image: '/application/_0002_4.jpg', title: 'Reflective Material Cutting' },
        { image: '/application/_0003_3.jpg', title: 'Industrial Production' },
        { image: '/application/_0004_2.jpg', title: 'Short-Run Manufacturing' },
        { image: '/application/_0005_1.jpg', title: 'Auto Feeding Applications' }
    ];
    ...
    useEffect(() => {
        ...
        const autoScroll = () => {
            ...
            if (!isDraggingRef.current) {
                currentContainer.scrollLeft += 0.35;
                normalizeInfiniteBoundary();
            }
                ...
                <section className="iecho-pk4-applications-section">
                    <div className="iecho-pk4-applications-container">
                        ...
                        <div
                            ...
                            onScroll={normalizeInfiniteBoundary}
